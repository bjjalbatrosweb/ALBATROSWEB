        ...
        <section className="grid gap-5 xl:grid-cols-[420px_1fr]">
          <div className="rounded-[26px] border border-white/10 bg-[#090b0d] p-4 shadow-xl">
            ...
            <div className="mb-3 grid gap-2 sm:grid-cols-[1fr_150px] xl:grid-cols-1">
              <label className="relative"><Search className="absolute left-3 top-1/2 h-4 w-4 -translate-y-1/2 text-white/35" /><input value={search} onChange={(event) => setSearch(event.target.value)} placeholder="Buscar atleta…" className="competition-input pl-9" /></label>
