...
import { Star, Award, Trophy, Info, ChevronDown, Eye, Gift, Zap } from "lucide-react";
                            ...
                            <Dialog>
                              ...
                              <DialogContent className="sm:max-w-2xl bg-card/95 backdrop-blur-xl border-primary/20">
                                <DialogHeader className="text-center">
                                  ...
                                  <p className="font-bold text-muted-foreground">Premios de Élite Albatros disponibles</p>
                                </DialogHeader>
