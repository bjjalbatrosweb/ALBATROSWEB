  ...
  return (
    <div className="p-4 md:p-8 space-y-8 max-w-4xl mx-auto">
      <header className="text-center space-y-2">
        ...
        <h1 className="text-4xl font-black tracking-tighter uppercase italic">Dados de Combate</h1>
        <p className="text-muted-foreground">Genera escenarios tácticos aleatorios para tu entrenamiento.</p>
      </header>
